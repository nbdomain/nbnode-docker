...
const CONFIG = {
  debug: true,
  key: "KyQYxHjX7ZHhNVamhuNs9JgvR7SM5FuMnbverckPLKi2ZG31zy5R", //unique node key. use 'node key -c bitcoin' to generate
  ...
  server: {
    publicUrl: "http://pi.skyjeff.com:10000", //public domain name or IP of the node, must set for public node and not set for private node
  ...
  pnodes: ["http://pi.skyjeff.com:9300"],//other(than public) nbnode peers and will not share with other nodes
